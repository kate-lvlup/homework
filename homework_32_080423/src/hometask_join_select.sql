...
INSERT INTO public.customers(customer_name, customer_email)
VALUES ('John', 'john@test.com'),
       ('Jane', 'jane@test.com'),
       ('Bob', 'bob@test.com'),
       ('British', 'british@test.com'),
       ('Sarahs', 'sarahs@test.com'),
       ('Carcus', 'carcus@test.com'),
       ('Hikoza', 'hikoza@test.com'),
       ('Bartak', 'bartak@test.com'),
       ('Tommie', 'tommie@test.com'),
       ('Jessica', 'jessica@test.com'),
       ('Austin', 'austin@test.com'),
       ('Barak', 'barak@test.com'),
       ('Tom', 'tom@test.com'),
       ('Jerry', 'jerry@test.com'),
       ('Donald', 'donald@test.com'),
       ('Suzy', 'suzy@test.com'),
       ('Mia', 'mia@test.com'),
       ('Lian', 'lian@test.com');
